...
export async function createSmepayTransaction(payload: {
  ...
  const body = {
    ...
    callback_url: process.env.SMEPAY_CALLBACK_URL || (process.env.SERVER_URL ? `${process.env.SERVER_URL}/api/payments/webhook/smepay` : "https://payments.versaitechnology.com/api/payments/webhook/smepay"),
